...
export default function RightPanel({ isOpen, onClose }: RightPanelProps) {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                {/* Panel header */}
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-[#232f3e] text-white">
