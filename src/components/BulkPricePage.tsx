...
export default function BulkPricePage({ onBack }: { onBack: () => void }) {
    ...
    <div className="flex-1 bg-gray-50 overflow-auto">
      <div className="px-6 py-4">
        <div className="mb-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Bulk Price Management</h1>
        </div>
          ...
          {showFilters && (
            <div className="p-4 bg-white border-b border-gray-200">
              <div className="flex items-center gap-4">
                <div>
                  <label className="block text-xs text-gray-700 mb-1">Actions</label>
                  <select className="px-3 py-2 text-sm border border-gray-300 rounded bg-white min-w-[200px]">
                    <option>Price increase</option>
                    <option>Price decrease</option>
                  </select>
                </div>
                <div>
                  <label className="block text-xs text-gray-700 mb-1">Parent</label>
                  <select className="px-3 py-2 text-sm border border-gray-300 rounded bg-white min-w-[200px]">
                    <option>All</option>
                  </select>
                </div>
                <div>
                  <label className="block text-xs text-gray-700 mb-1">Purchase child/variant</label>
                  <input
                    type="text"
                    placeholder="Purchase child/variant"
